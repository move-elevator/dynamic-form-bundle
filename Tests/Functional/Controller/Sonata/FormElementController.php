...
class FormElementControllerTest extends WebTestCase
{
    ...
    {
        $this->client->request(Request::METHOD_GET, '/admin/dynamic-form/form/1/form-element/1/delete');
    ...
    {
        $this->client->request(Request::METHOD_GET, '/admin/dynamic-form/form/1/form-element/1/clone');
